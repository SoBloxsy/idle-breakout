(function () {
    ...
    upload_id = (ref1 = window.location.href) != null ? ((ref2 = ref1.match(/\/html\/(\d+)/)) != null ? ref2[1] : void 0) : void 0;
    is_hotlink = ((ref3 = document.location.href) != null ? ref3.match(/^https?:\/\/commondatastorage\.googleapis\.com\/itchio\//) : void 0) ? true : domain && !(domain === "itch.io" || domain.match(/\.itch\.io$/)) ? true : void 0;
    is_hotlink = false;
